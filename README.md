...
| 功能 | 说明 |
|------|------|
| Prompt 优化 | 提高注释准确性和一致性 |
| 多进程优化 | 使用 multiprocessing 替代线程池，避免 GIL 限制 |
| 单元测试 | pytest 测试套件 |
...
| 功能 | 说明 |
|------|------|
| Web 界面 | Flask/FastAPI Web 应用 |
| 结果可视化 | UMAP/t-SNE 标注可视化 |
| 更多 LLM 提供商 | 支持本地模型、Azure 等 |
| 基因数据库集成 | 自动查询基因功能注释 |
| 批量处理 | 支持多样本批量注释 |
| 结果导出 | 支持 Seurat/Scanpy 格式 |
